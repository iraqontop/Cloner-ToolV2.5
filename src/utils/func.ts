    ...
    try {
      ...
      if (createNewServer) {
        ...
        const newGuild = await client.guilds.create(
          ...
          {
            icon:
              'https://images-ext-1.discordapp.net/external/eP5PJPpjRHGFsnRN_OB0EgoIc7DAxIXiQNCJJbfWnzY/%3Fsize%3D4096/https/cdn.discordapp.com/icons/1099463270399750206/ee1e051bbe9f8a4f9c49e87787e2d8de.png?format=webp&quality=lossless',
          }
        );
